...
Picodata **Community Edition** + Redis (stand-in for commercial **Radix**) + MinIO + NATS JetStream.
...
| Component | Image |
|-----------|--------|
| Picodata CE | `docker.binary.picodata.io/picodata:25.5.9` (also on `docker-public.binary.picodata.io`) |
